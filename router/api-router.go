...
func SetApiRouter(router *gin.Engine) {
	...
	// CORS preflight requests use OPTIONS; Gin won't match group middleware unless an OPTIONS route exists.
	...
	})
	{
		...
		apiRouter.GET("/pricing_config", middleware.CriticalRateLimit(), controller.GetPricingConfig)
		// backward compatible
		...
		userRoute := apiRouter.Group("/user")
		{
			...
			selfRoute.Use(middleware.UserAuth())
			{
				...
				selfRoute.POST("/topup/refund", middleware.CriticalRateLimit(), controller.RefundTopUpSelf)
