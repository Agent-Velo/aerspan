# Aerspan Electron Desktop App

This directory contains the Electron wrapper for Aerspan, providing a native desktop application with system tray support for Windows, macOS, and Linux.
...
- **Production**:
  - macOS: `~/Library/Application Support/Aerspan/data/`
  - Windows: `%APPDATA%/Aerspan/data/`
  - Linux: `~/.config/Aerspan/data/`
