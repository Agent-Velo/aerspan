...
|-----------|--------|-----------|----------|
| 定价 | Тарификация | Pricing | Единичная цена тарификации (USD/1M tokens) |
| 系数 | Коэффициент | Multiplier | Множитель, применяемый к тарифу (в зависимости от группы/пользователя) |
...
| 输入价格 | Цена ввода | Input Price | Цена за входные токены (USD/1M tokens) |
| 输出价格 | Цена вывода | Output Price | Цена за выходные токены (USD/1M tokens) |
| 缓存读取价格 | Цена чтения кеша | Cache Read Price | Цена за токены, прочитанные из кеша (USD/1M tokens) |
