...
func checkMySQLChineseSupport(db *gorm.DB) error {
	...
	if !isChineseCapable(schemaCharset, schemaCollation) {
		return fmt.Errorf("Schema default charset/collation isn't CJK-capable: schema(%s/%s). Set it to utf8mb4/utf8/gbk/big5/gb18030",
	...
	if len(badTables) > 0 {
		...
		return fmt.Errorf(
			"Found tables with non-CJK-capable collations/charsets. Fix their collation/charset. Examples (up to %d): %v",
			maxShow, shown,
		)
	}
	return nil
